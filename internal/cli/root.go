...
import (
	...
	"uspto-patents-pp-cli/internal/client"
	"uspto-patents-pp-cli/internal/config"
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "uspto-patents-pp-cli",
		Short: `Uspto Patents CLI — Every patent prosecution feature from every existing tool, plus offline search, family trees, and portfolio analytics n…`,
		Long: `Uspto Patents CLI — Every patent prosecution feature from every existing tool, plus offline search, family trees, and portfolio analytics n…
...
Health check: run 'uspto-patents-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("uspto-patents-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'uspto-patents-pp-cli profile list')")
	...
	rootCmd.AddCommand(newPatentCmd(flags))
	rootCmd.AddCommand(newPetitionCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("uspto-patents-pp-cli %s\n", version)
		},
	}
}
